...
export default function LargeScreenCategorySelection({ id }) {
  ...
  return (
    <div className={`hidden lg:block mr-7 text-primary-blue`}>
          ...
          return (
            <div key={index}>
                  ...
                  <div>
                    {item.brandItems.map((childitem, childindex) => (
                      <div key={`childitem2-${childindex}` } className="my-1">
                        <input
                          type="checkbox"
                          id={`checkbox2-${childindex}`}
                          className="mr-2 cursor-pointer"
                        />
                        <label
                          htmlFor={`checkbox2-${childindex}`}
                          className="text-sm"
                        >
                          {childitem}
                        </label>
                ...
                {!sizeArrowClick && (
                  <div>
                    {item.sizeList.map((childitem, childindex) => (
                      <div key={`childitem3-${childindex}`} className="my-1">
                        <input
                          type="checkbox"
                          id={`checkbox3-${childindex}`}
                          className="mr-2 cursor-pointer"
                        />
                        <label
                          htmlFor={`checkbox3-${childindex}`}
                          className="text-sm"
                        >
                          {childitem}
                        </label>
                ...
                {!warrantyArrowClick && (
                  <div>
                    {item.productItems.map((childitem, childindex) => (
                      <div key={`childitem4-${childindex}`} className="my-1">
                        <input
                          type="checkbox"
                          id={`checkbox4-${childindex}`}
                          className="mr-2 cursor-pointer"
                        />
                        <label
                          htmlFor={`checkbox4-${childindex}`}
                          className="text-sm"
                        >
                          {childitem}
                        </label>
